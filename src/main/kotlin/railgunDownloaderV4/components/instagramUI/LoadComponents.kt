...
import railgunDownloaderV4.components.instagramUI.events.Download
...
class LoadComponents {
    ...
    fun setLoadComponent(appTarget: JFrame) {
        textField.setTextField(
            appTarget, urlField, Dimension(400, 30),
            Point(100, 450), true,
            "Input your Instagram video URL here"
        )
        textField.setTextField(
        ...
        buttonUI.setButtonUI(
            ...
            "/Download.png", "Download video from Instagram"
        )
